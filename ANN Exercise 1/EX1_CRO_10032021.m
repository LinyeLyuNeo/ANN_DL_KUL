...
net1.trainParam.epochs=delta_epochs(4);
net2.trainParam.epochs=delta_epochs(4);
net1=train(net1,x,t);
net2=train(net2,x,t);
a14=sim(net1,x); a24=sim(net2,x);
...
subplot(4,3,10);
plot(x,t,'bx',x,a14,'r',x,a24,'g');
title([num2str(epochs(4)),' epoch']);
legend('target',alg1,alg2,'Location','north');
subplot(4,3,11);
postregm(a14,y);
subplot(4,3,12);
