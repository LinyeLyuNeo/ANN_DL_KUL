...
% disp('Basic CNN with only 1 convolutional layer v2');
% 
...
% disp('Basic CNN with 2 convolutional layer');      
%       
% layers = [imageInputLayer([28 28 1])
...
% disp('Basic CNN with only 1 convolutional layer v3');      
%       
% layers = [imageInputLayer([28 28 1])
%           convolution2dLayer(5,20)
%           reluLayer
...
% disp('Basic CNN with only 1 convolutional layer v4');      
%       
% layers = [imageInputLayer([28 28 1])
...
% disp('Basic CNN with 2 convolutional layer v2')
% 
% layers = [imageInputLayer([28 28 1])
%   convolution2dLayer(5,12)
%   reluLayer
...
disp('Basic CNN with 3 convolutional layer v1');      
